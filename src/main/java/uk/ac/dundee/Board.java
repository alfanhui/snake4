...
public class Board extends JPanel implements ActionListener {
	...
	private void loadImages() {
		String snakeUrl = new File(getClass().getClassLoader().getResource("snake.png").getFile()).getPath();
		ImageIcon iia = new ImageIcon(snakeUrl);
		snake = iia.getImage();
		String foodUrl = new File(getClass().getClassLoader().getResource("food.png").getFile()).getPath();
		ImageIcon iib = new ImageIcon(foodUrl);
		food = iib.getImage();
		String portalBlueUrl = new File(getClass().getClassLoader().getResource("portalBlue.png").getFile()).getPath();
		ImageIcon iic = new ImageIcon(portalBlueUrl);
		portalBlue = iic.getImage();
		String portalOrangeUrl = new File(getClass().getClassLoader().getResource("portalOrange.png").getFile()).getPath();
		ImageIcon iid = new ImageIcon(portalOrangeUrl);
		portalOrange = iid.getImage();
		String softWallUrl = new File(getClass().getClassLoader().getResource("softWall.png").getFile()).getPath();
		ImageIcon iie = new ImageIcon(softWallUrl);
	...
	public static void selectLevel() {
		...
		String selectedValue = (String) JOptionPane.showInputDialog(null, "Choose a level", "Level",
	...
	private static boolean exitWarning() {
		...
		end = JOptionPane.showOptionDialog(null, "Click OK to exit the game", "Warning", JOptionPane.DEFAULT_OPTION,
